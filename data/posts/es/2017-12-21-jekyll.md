...
Aquí se establece la URL completa de la imagen de portada para las redes sociales. Puedes obtener más información sobre las etiquetas og en la lección "[Integración con redes sociales y web semántica](https://codica.la/cursos/html/lessons/social/theory_unit)" del curso gratuito [Fundamentos de HTML, CSS y diseño web](https://codica.la/cursos/html) en Hexlet.
