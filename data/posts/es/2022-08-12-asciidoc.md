...
AsciiDoc se parece al formato de marcado [Markdown](http://codica.la/guias/markdown). Si has trabajado con él, muchas cosas te parecerán similares e intuitivas. Y viceversa, si conoces AsciiDoc, usar Markdown no será difícil.
